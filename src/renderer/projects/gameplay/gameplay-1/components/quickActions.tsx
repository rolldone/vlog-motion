// ─── Quick action items — static data ───

// Break icon — from break-time-icon.svg with gradient colors
function BreakIcon({ size = 48 }: { size?: number }) {
  return (
    <svg width={size} height={size * 105.5 / 122.88} viewBox="0 0 122.88 105.5" xmlns="http://www.w3.org/2000/svg">
      <defs>
