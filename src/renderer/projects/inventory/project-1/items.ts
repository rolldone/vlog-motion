...
export const INITIAL_ITEMS: InventoryItem[] = [
  ...
  { id: 'camera',     label: 'Camera',     icon: '📷', durability: 100, maxDurability: 100, useMode: 'single' },
  ...
  { id: 'tongkat',    label: 'Tongkat',    icon: '🦯', durability: 100, maxDurability: 100, useMode: 'single' },
  { id: 'smartphone', label: 'Smartphone', icon: '📱', durability: 100, maxDurability: 100, useMode: 'single' },
]
